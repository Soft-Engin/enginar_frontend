...
const SettingsPage = () => {
    ...
    useEffect(() => {
        const fetchSelectedAllergens = async () => {
            try {
                ...
                else if (response.data && response.data.message === "No allergens found for the given user.") {
    ...
    return (
        ...
        >
            <Box sx={{ display: "flex", pt: 2, pl: 2, justifyContent: "space-between", alignItems: "center" }}>
            ...
            <Box sx={{ flexGrow: 1, display: "flex", flexDirection: "column" }}>
                ...
                <Box sx={{ mb: 2, pr: 2, pl: 2, flexGrow: 1 }}>
                    <Box sx={{ mb: 2, display: "flex", flexWrap: "wrap", gap: 1, maxWidth: "100%", overflowX: "hidden" }}>
                ...
                <Paper elevation={3} sx={{ p: 3, mb: 3, backgroundColor: "rgba(255, 255, 255, 0.9)" }}>
                    <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 2, pr: 2, pl: 2 }}>
            ...
            <Box sx={{ display: "flex", justifyContent: "flex-end", gap: "12px", mt: 4, pr: 2, pl: 2 }}>
                <Button
                    variant="outlined"
                    sx={{ color: "black" }}
                    color="black"
