...
export default function EventDetailed() {
  return(
    <Box>
      <Box sx={{ maxWidth: 1000, outline: "1.5px solid #C0C0C0", backgroundColor: "#FFFFFF", p: 5, borderRadius: "20px 20px 0 0" }} >
        ...
        <Typography variant="h6" component="div" fontWeight="bold" style={{ marginTop: '15px' }}>
          Participants:
        </Typography>
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <Button variant="contained" style={{ backgroundColor: "#4B9023", borderRadius: 30, width: "120px", height: "50px", textTransform: "none" }}>
      ...
      <Box sx={{ maxWidth: 1000, outline: "1px solid #C0C0C0", backgroundColor: "#EAEAEA", p: 4, borderRadius: "0 0 15px 15px" }}>
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 1, mr: 2.5 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', flexGrow: 1, mb: 1 }}>
