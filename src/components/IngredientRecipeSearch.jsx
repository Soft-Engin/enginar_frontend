...
const RecipeSearch = () => {
    ...
    const searchRecipes = async (pageToSearch) => {
        ...
        try {
            ...
            params.append("num", pageToSearch);
    ...
    return (
        <Box sx={{ p: 4, width: "95vw", overflow: "hidden", height: "90vh" }}>
                    ...
                    >
                        ...
                        <Divider>
                            <Typography variant="subtitle1" color="textSecondary">
                                {totalRecipes} {totalRecipes === 1 ? "Recipe" : "Recipes"} Found  (Page {page} of {totalPages > 0 ? totalPages : 1})
                            </Typography>
                        </Divider>
                        <LoadingErrorDisplay loading={loadingRecipes} error={errorRecipes} />
                       ...
                       {/* Recipe List */}
                        <Box
                            sx={{
                                ...
                                flex: 1,
                                p: 1,
                                maxHeight: "calc(100% - 180px)" // Set a max height and subtract the other parts of the column so there is no overflow
                            }}
                        >
