...
export default function RecipeDetailed() {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="https://cdn.yemek.com/mncrop/940/625/uploads/2015/03/zeytinyagli-enginar-yemekcom.jpg"
          alt="Enginar Yemeği"
          style={{
            width: "100%",
            height: "300px",
        ...
        >
          <Typography
            ...
            fontFamily="Georgia"
            color="white"
            sx={{ textAlign: "center", mb: 1, textShadow: "1px 1px 2px black" }}
          >
            My Artichoke Recipe
          </Typography>
          <Box
      ...
      >
        <ListItem>
          Sauté 1 finely chopped onion in half a cup of olive oil in a pan until
          it turns slightly golden.
        </ListItem>
        <ListItem>
          Add 1 diced and boiled potato and carrot to the pan. Cook for another
          2-3 minutes.
        </ListItem>
        <ListItem>
          Add 1 cup of peas to the mixture, cook for 3-4 minutes, then remove
          your garnish from the heat.
        </ListItem>
        <ListItem>
          To prepare the sauce for cooking the artichokes, mix 2 freshly
          squeezed lemons, 1 cup of water, 1 teaspoon of sugar, 1/2 teaspoon of
          salt, and 2 tablespoons of olive oil in a bowl.
        </ListItem>
        <ListItem>
          Place 8 artichokes in a wide pot and fill each with the prepared
          garnish.
        </ListItem>
        <ListItem>Pour the lemon sauce mixture into the pot.</ListItem>
        <ListItem>
          Cover the lid and cook until the artichokes are tender.
        </ListItem>
