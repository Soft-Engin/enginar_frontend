...
export default function RecipeDetailed() {
  return(
    <Box sx={{ maxWidth: 1500, outline: "1.5px solid #C0C0C0", backgroundColor: "#FFFFFF", pl: 4, pr: 4, pt: 2, pb: 1, borderRadius: "20px 20px 0 0" }} >
      ...
      <Box sx={{ mb: 1.5, position: "relative", overflow: "hidden" }}>
        <img src="https://via.placeholder.com/400x225" alt="Enginar Yemeği" style={{ width: "100%", height: "300px", display: "block", objectFit: "cover", filter: "blur(2px)" }} />
        <Box sx={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: "rgba(0, 0, 0, 0.4)" }}>
          ...
          <Box sx={{ display: "flex", justifyContent: "center", gap: 4, mt: 1, padding: "5px 10px", backgroundColor: "rgba(255, 255, 255, 0.8)", borderRadius: "5px", boxShadow: 3 }}>
      ...
      <Typography variant="body1" sx={{ lineHeight: "25px", mb: 1, pb: 1, borderBottom: "1px solid #E0E0E0" }}>
